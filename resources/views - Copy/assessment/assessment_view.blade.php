                    ...
                    <table class="table">
                        <tbody>
							<tr>
								...
								<th class="th-position text-uppercase font-500 font-12">rate common value</th>
							</tr>
							...
							<tr>
								...
								<td><a href="assessment_set_point/{{ $assessment->assessment_id }}"><i class="material-icons material-icons gray md-22"> rate_review </i></a></td>
							</tr>
							@endforeach
                        </tbody>
                    </table>					
