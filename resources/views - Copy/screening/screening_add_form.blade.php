							...
							<form action="{{action('ScreeningController@add_responsible_person')}}" method="post" enctype="multipart/form-data>
								...
								<div class="col-md-6">
									...
									<div class="form-group has-feedback">
										<label>Name</label>
										<input type="text" class="form-control" placeholder="" name="responsible_person_responsible" required pattern="[A-Za-z\s]+" Title="Alphabate Character Only"/>									
									</div>
									<div class="form-group has-feedback">
							...
							<form action="{{action('ScreeningController@add_resident_details')}}" method="post">
								...
								<div class="col-md-6">
									...
									<div class="form-group has-feedback">
										...
										<select name="height_resident" id="height_resident" class="myselect" style="width:100%; height: 34px;" onkeyup="getRangeinfo();" required >
									...
									<div class="form-group has-feedback">
										...
										<select name="weight_resident" id="weight_resident" class="myselect" style="width:100%; height: 34px;" onkeyup="getRangeinfo();" required >
									...
									<div class="form-group has-feedback">
										...
										<input type="text" class="form-control" placeholder="" name="social_security_resident" required />									
									</div>
								</div>	
								<div class="col-md-6">
									<div class="form-group has-feedback">
						...
						<div class="tab-pane fade" id="dentist" role="tabpanel" aria-labelledby="dentist-tab">
							<form action="{{action('ScreeningController@add_pharmacy')}}" method="post">
								...
								<div class="col-md-6">
									...
									<div class="form-group has-feedback">
										<button type="submit" class="btn btn-primary btn-block btn-flat btn-width" style="margin-top:48px">Submit</button>										
									</div>								
								</div>
							</form>
						</div>
							...
							<form action="{{action('ScreeningController@add_equipment')}}" method="post">
								...
								<div class="col-md-6">
									<div class="form-group has-feedback">
										...
										<input type="text" name="inconsistency_supplies_type" id="" value="" class="form-control">	
									</div>
								</div>
								
								<div class="col-md-6">
									<div class="form-group has-feedback">
										<label>PRESSURE RELIEF DEVICES TYPE*</label>
										<input type="text" name="pressure_relief_dev_type" id="" value="" class="form-control">	
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="form-group has-feedback">
										<button type="submit" class="btn btn-primary btn-block btn-flat btn-width" style="margin-top:48px; margin-right:15px">Submit</button>										
									</div>	
