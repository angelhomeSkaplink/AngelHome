                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <th class="th-position text-uppercase font-500 font-12">Pharmacy Email</th>
                            <th class="th-position text-uppercase font-500 font-12">Phone</th>
                            <th class="th-position text-uppercase font-500 font-12">Location</th>
                            <th class="th-position text-uppercase font-500 font-12">Renewed</th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="th-position font-12">{{ $stock->pharmacy_email }}</td>
                            <td class="th-position font-12">{{ $stock->pharmacy_phone }}</td>
                            <td class="th-position font-12">{{ $stock->pharmacy_location }}</td>

                            <td class="th-position font-12">
                                <a href="renewal_complete/{{ $stock->medi_stock_id }}" data-toggle="tooltip" data-placement="bottom" onclick="return confirm_click();" title="Renewed">
