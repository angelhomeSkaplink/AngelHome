              ...
              if(data.length === 0){
                ...
                new Chart(document.getElementById("bar-chart"), {
                    ...
                    options: {
                        ...
                        title: {
                        display: true,
                        text: 'Post Evaluation Fall Graph Report'
                        },
                    onClick: onClick
                    }
                });
...
<div class="row">
	<div class="col-lg-4 col-lg-offset-4 text-center">
	    <h3 style="margin:0px;color:rgba(0, -3, 0, 0.87) !important;"><strong>Post Fall Evaluation Summary</strong></h3>
    </div>
        ...
        <table class="table table-hover hidden" id="resultTable">
            <thead class="thead-light">
                <tr class="text-center">
                    <th class="th-position text-uppercase font-500 font-12">@lang("msg.Potential Causal factors")</th>
                    <th class="th-position text-uppercase font-500 font-12">@lang("msg.Fall Risk")</th>
                    <th class="th-position text-uppercase font-500 font-12">@lang("msg.After a Fall")</th>
                    <th class="th-position text-uppercase font-500 font-12">@lang("msg.Falls with Potential Causal Factors")</th>
                    <th class="th-position text-uppercase font-500 font-12">@lang("msg.% Falls with Potential Causal Factors")</th>
                </tr>
            </thead>
