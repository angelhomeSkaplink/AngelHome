...
@section('contentheader_title')
	...
	<a href="{{ url('facility_room_graph/' . $id) }}" class="btn btn-primary btn-block btn-flat btn-width btn-custom" style="width:150px !important; height:26px !important"><i class="material-icons md-14 font-weight-600"> details </i> Back to graph</a>
    </p>
@endsection
