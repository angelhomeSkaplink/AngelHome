...
@section('htmlheader_title')
    Falls With Injury Type And Treatment Location Summary
@endsection
              ...
              if(response[1]=='None'){
                ...
                new Chart(document.getElementById("bar-chart1"), {
                    ...
                    options: {
                        ...
                        title: {
                        display: true,
                        text: 'Injury Treatment By Location'
                        },
                    onClick: onClick
                    }
                });
...
<div class="row">
	<div class="col-lg-4 col-lg-offset-4 text-center">
	    <h3 style="margin:0px;color:rgba(0, -3, 0, 0.87) !important;"><strong>@lang("msg.Falls With Injury Type And Treatment Location Summary")</strong></h3>
    </div>
        ...
        <div class="print-header">
				...
				<div class="box box-primary border hidden" id="resultTable">
					...
					<div class="col-lg-5 text-center">
						<div class="box box-primary border padding-7">
							<div class="box-body border padding-top-0 padding-left-right-0 table-responsive">
							    <h4 class="text-center"><strong>@lang("msg.Fall With Injury By Type")</strong></h4>
							    <hr>
								<table class="table table-hover" >
										<thead class="thead-light">
												<tr>
														<th class="text-center th-position text-uppercase font-500 font-12">@lang("msg.Injury Type")</th>
														<th class="text-center th-position text-uppercase font-500 font-12">#@lang("msg.By Type")</th>
														<th class="text-center th-position text-uppercase font-500 font-12">%@lang("msg.Injury Type")</th>
												</tr>
										</thead>
					...
					<div class="col-lg-7 text-center">
						<div class="box box-primary border padding-7">
							<div class="box-body border padding-top-0 padding-left-right-0 table-responsive">
							    <h4 class="text-center"><strong>@lang("msg.Injury Treatment By Location")</strong></h4>
							    <hr>
								<table class="table table-hover">
										<thead class="thead-light">
												<tr>
														<th class="text-center th-position text-uppercase font-500 font-12">@lang("msg.Injury Treatment Location")</th>
														<th class="text-center th-position text-uppercase font-500 font-12">#@lang("msg.By Treatment Location")</th>
														<th class="text-center th-position text-uppercase font-500 font-12">%@lang("msg.By Treatment Location")</th>
												</tr>
										</thead>
