...
<div class="row">
	<div class="col-lg-4 col-lg-offset-4 text-center">
	    <h3 style="margin:0px;color:rgba(0, -3, 0, 0.87) !important;"><strong>@lang("msg.Location Summary")</strong></h3>
    </div>
    ...
    <div class="table-responsive" id="printableDiv" style="height:430px;">
        ...
        <table class="table table-hover hidden" id="resultTable">
            <thead class="thead-light">
                <tr>
                    <th class="text-center th-position text-uppercase font-500 font-12">@lang("msg.Location")</th>
                    <th class="text-center th-position text-uppercase font-500 font-12">#@lang("msg.Falls by Location")</th>
                    <th class="text-center th-position text-uppercase font-500 font-12">%@lang("msg.Falls by Location")</th>
                </tr>
            </thead>
