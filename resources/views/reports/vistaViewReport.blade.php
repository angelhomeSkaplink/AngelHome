...
<script type="text/javascript">
  ...
  function showGraph(){
    ...
    $('#barChartDiv').addClass('hidden');  
        ...
        var backgroundColor = ["#8e5ea2","#3cba9f","#e8c3b9","#c45850","#a1d3f9", "#ffff00", "#1a0000","#009933","#0000cc", "#cc0066", "#86592d","#a1d3f9", "#ffff00", "#1a0000","#009933","#0000cc"];
        $.ajaxSetup({
        headers: {
    ...
    <div class="table-responsive" id="printableDiv" style="height:430px;">
        ...
        <table class="table table-hover hidden" id="resultTable">
            <thead class="thead-light">
                <tr>
                    <th class="text-center th-position text-uppercase font-500 font-12">@lang("msg.Sales Stage")</th>
                    <th class="text-center th-position text-uppercase font-500 font-12">@lang("msg.Total")</th>
                </tr>
            </thead>
