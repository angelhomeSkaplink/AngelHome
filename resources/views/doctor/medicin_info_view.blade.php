...
<div class="row">
  <div class="col-lg-12">
    <p><strong>Note:- <br> </strong> <i class="material-icons md-36"> offline_pin</i> Given in due time
      <strong>::</strong> <i class="material-icons md-36"> check_circle_outline </i> Given either early or late
      <strong>::</strong> <i class="material-icons md-36"> hourglass_empty</i> PRN action pending <strong>::</strong> <i
        class="material-icons md-36"> cancel</i> Not given <strong>::</strong> <i class="material-icons md-36">
        email</i> Refused-Mail sent to Doctor</p>
  </div>
</div>
<div class="row">
  <div class="col-md-12">
    <div class="box box-primary border">
      <div id="DivIdToPrint">
        <div class="box-body border padding-top-0 padding-left-right-0" style="height:450px;">
          <div class="table-responsive" style="height:350px;">
            <table class="table">
              <tbody>
                ...
                @endphp
                <?php
								$history = DB::table('medicine_history')->where([['pat_medi_id', $medicine->pat_medi_id],['freq', $medicine->frequency]])
                  ...
                  if($history){ 
                  $due_time=date('h:i A', strtotime($medicine->time_to_take));
                ?>
                <tr>
                  @if($medicine->service_image == NULL)
                  <td><img src="hsfiles/public/img/538642-user_512x512.png" class="img-circle" width="40" height="40">
                  </td>
                  @else
                  <td><img src="hsfiles/public/img/{{ $medicine->service_image }}" class="img-circle" width="40"
                      height="40"></td>
                  @endif
                  <td>{{ $n[0] }} {{ $n[1] }} {{ $n[2] }}</td>
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <form class="" action="{{ action('DoctorController@add_history') }}" method="post">
                          ...
                          <input type="hidden" name="freq" value="{{ $medicine->frequency }}" />
                        ...
                        <a class="dropdown-item" href="#"
                          onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-black">Not
                          Given</a>
                        <a class="dropdown-item" href="#"
                          onclick="document.getElementById('email-modal').style.display='block'"
                          class="w3-button w3-black">Refused</a>
                      </div>
                    </div>
                        ...
                        <div class="w3-modal-content w3-animate-zoom w3-card-4">
                          ...
                          <div class="w3-container text-muted" style="padding-top:10px;">
                            <div class="form-group" style="padding:20px;">
                              <div><input class="form-control" type="email" name="to"
                                  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="To" value=""
                                  required /></div>
                              <div style="margin-top:5px;margin-bottom:5px;"><input class="form-control" type="text"
                                  name="subject" placeholder="Subject" value="" required /></div>
                              <div><textarea class="form-control" name="msg_body" rows="8" placeholder="Message body"
                          ...
                          <footer class="w3-container" style="background-color:#f1f1f1;color:#fff;">
                            <span class="pull-right" style="padding:10px;">
                              ...
                              <span class="btn btn-default"
                                onclick="document.getElementById('email-modal').style.display='none'">Cancel</span>
                            </span>
                          </footer>
                        </div>
                      </form>
                        ...
                        <div class="w3-modal-content w3-animate-zoom w3-card-4">
                          ...
                          <div class="w3-container text-muted" style="padding-top:10px;">
                            ...
                            <div class="form-group hidden" id="reasonTextContainer">
                              <textarea id="desc_req" name="reason_desc" rows="5" class="form-control"
                                placeholder="Write a brief explaination here" style="resize:none;"></textarea>
                            </div>
                          </div>
                          <footer class="w3-container" style="background-color:#f1f1f1;color:#fff;">
                            <span class="pull-right" style="padding:10px;">
			   ...
			   ?>
                  ...
                  <td>
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="#" id="not_affect"
                          onclick="document.getElementById('prn_not_affected_modal').style.display='block'"
                          class="w3-button w3-black">Not affected</a>
                        <a class="dropdown-item" href="#" id="affect"
                          onclick="document.getElementById('prn_affected_modal').style.display='block'"
                          class="w3-button w3-black">Affected</a>
                      </div>
                    </div>
                        ...
                        <div class="w3-modal-content w3-animate-zoom w3-card-4">
                          ...
                          <div class="w3-container text-muted" style="padding-top:10px;">
                            <div class="form-group" id="">
                              <textarea id="desc_req" name="reason_desc" rows="5" class="form-control"
                                placeholder="Write a brief explaination here" style="resize:none;" required></textarea>
                            </div>
                          </div>
                          <footer class="w3-container" style="background-color:#f1f1f1;color:#fff;">
                            <span class="pull-right" style="padding:10px;">
                              <button name="submit" type="submit" class="btn btn-success">Mark as Complete</button>
                              <span class="btn btn-default"
                                onclick="document.getElementById('prn_affected_modal').style.display='none'">Cancel</span>
                            </span>
                          </footer>
                        </div>
                      </form>
                        ...
                        <div class="w3-modal-content w3-animate-zoom w3-card-4">
                          ...
                          <footer class="w3-container" style="background-color:#f1f1f1;color:#fff;">
                            <span class="pull-right" style="padding:10px;">
                              <button name="submit" type="submit" class="btn btn-success">Mark as Complete</button>
                              <span class="btn btn-default"
                                onclick="document.getElementById('prn_not_affected_modal').style.display='none'">Cancel</span>
                            </span>
                          </footer>
                        </div>
                      </form>
