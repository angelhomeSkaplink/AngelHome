{{-- Lease Signing Documents --}}
@if ($print_conf->lease_signing_doc != "0")
<div class="row">
  <div class="col-lg-12">
    <div class="box box-primary border-light-blue">
      <div class="box-body padding-top-5" style="padding-bottom:10px">
        <h3 style="text-align:center"><strong>Lease Signing Documents</strong></h3>
        <div class="form-inline border-top" style="padding-top:10px">
          @php
            $doc_list = explode(",",$print_conf->lease_signing_doc);
          @endphp
