...
@section('contentheader_title')
    <p class="text-danger"><b>Stocks List</b>
        ...
        ?>
       <a href="{{ url('add_stocks') }}" class="btn btn-primary btn-block btn-flat btn-width btn-custom" style="width:135px !important; margin-top: -2px; margin-bottom: 9px !important; margin-right: 10px;"><i class="material-icons md-14 font-weight-600" > add </i> Add new</a>
       <a href="{{ url('renew_list') }}" class="btn btn-primary btn-block btn-flat btn-width btn-custom" style="width:135px !important; margin-top: -2px; margin-bottom: 9px !important; margin-right: 10px;">Renew ({{ $count_alert }})</a>
    </p>
@endsection
