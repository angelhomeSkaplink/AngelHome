        ...
        <div class="container">
                ...
                <div class="text">
                  <div class="text-inner">
                    <h1> Oh no. Error 403 </h1>
                
                    <h2>Access Forbidded</h2>
                    <h2>We're sorry but you do not have permission to access whatever you were trying to access.</h2>

                    <h1>OR</h1>
                
                    <div id="home" class="button">
                            <a href="{{url('/')}}"><h3>GO HOME</h3></a>
                    </div>
                    </div>
