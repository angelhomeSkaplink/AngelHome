...
@section('contentheader_title')
	...
	<a href="{{ url('new_room_add') }}" class="btn btn-primary btn-block btn-flat btn-width btn-custom" style="width:187px !important; margin-top: -2px; margin-right: 10px;"><i class="material-icons md-14 font-weight-600"> add </i>@lang("msg.Add new room")</a>
