...
$( document ).ready(function() {
		var starttime = "{{ $details->event_time }}";
		var endtime = "{{ $details->end_time }}";
		var duration = "{{ $details->duration }}";
		var open_to = "{{ $details->open_to }}";
		console.log(open_to);
        $('#event_time').val(starttime);
			...
			<div class="box box-primary">				
				...
				<input type="hidden" name="event_id" value="{{$details->event_id}}">
					<div class="form-group has-feedback">
						...
						<input type="text" class="form-control" name="event_name" value="{{ $details->event_name }}" required />
					</div>
					<div class="form-group has-feedback form-inline">
						...
						<h2><span id="showEmojiId">&#x{{ $details->emoji_code }};</span></h2>
                    <input type="text" class="form-control hidden" class="hidden" placeholder="Add an icon" value="{{ $details->emoji_code }}" id="emoji_code" name="emoji_code" required />
					</div>
					<div class="form-group has-feedback">
						<label>@lang("msg.description") </label>
                    <textarea class="form-control" name="event_description" type="text" rows="4" value="" required >{{ $details->event_description }}</textarea>
					</div>
					<div class="form-group has-feedback">
						<label>@lang("msg.venue")</label>
                    <input type="text" class="form-control" name="event_place" id="event_place" value="{{ $details->event_place }}" required />
					</div>
					<div class="form-group has-feedback">
						...
						<select class="form-control" name="open_to" id="open_to" required>
						    ...
						    <option value="Family and Friends">@lang("msg.Family and Friends")</option>
						</select>
					</div>
					<div class="form-group has-feedback">
						<label>@lang("msg.start Date")</label>
                    <input type="text" class="form-control" name="event_date" id="event_date" value="{{ $details->event_date }}" autocomplete="off" required/>
					...
					<div class="form-group has-feedback">
						...
						<input type="text" class="form-control" name="event_end_date" id="event_end_date" value="{{ $details->event_end_date }}" autocomplete="off" required/>
