...
@section('htmlheader_title')
    @lang("msg.New Event Details")
@endsection

@section('contentheader_title')
<div class="row">
	<div class="col-lg-4 col-lg-offset-4 text-center">
		<h3 style="margin:0px;color:rgba(0, -3, 0, 0.87) !important;"><strong>@lang("msg.Add New Event")</strong></h3>
	</div>
</div>
@endsection
			...
			<div class="box box-primary">				
				<div class="box-body padding-bottom-15">
					...
					<div class="form-group has-feedback form-inline">
						<a href="#modal" id="emoji_btn" class="btn btn-success" data-toggle="modal" data-target="#myModal"><i class="material-icons md-36" style="color:#fff;"> add_circle </i>@lang("msg.Add Emoji")</a>
					...
					<div class="form-group has-feedback">
						...
						<select class="form-control" name="open_to" id="open_to" required>
						    <option value="Residents">@lang("msg.Residents")</option>
						    <option value="Family & Friends">@lang("msg.Family & Friends")</option>
						</select>
					</div>
					<div class="form-group has-feedback">
					...
					<div class="form-group has-feedback" >
						...
						<select name="duration" id="duration" class="form-control" onchange="calculateEndTime();" required>
							<option value="">@lang("msg.Select Duration")</option>
...
<div id="myModal" class="modal fade" role="dialog" style="z-index:9999999;">
	<div class="modal-dialog">
			<div class="modal-header" style="background-color:#1a1a1a;">
				...
				<h4 class="modal-title"><span style="color:#fff;">&#x1F605; @lang("msg.Add Emoji to the Event")!</span></h4>
			</div>
								...
								<div class="panel-body">
								  <div class="row">
									  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<h4><strong><u>@lang("msg.Smileys & People")</u></strong></h4>
										<?php
											$data1 = DB::table('emoji_library')->select('emoji_library.*')->where('category','=',1)->get();
										?>
										@if($data1->isEmpty())
										  <p style="font-size:0.8em;color:#b3b3b3;">@lang("msg.Not available")</p>
										@else
									  ...
									  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<h4><strong><u>@lang("msg.Animals & Nature")</u></strong></h4>
										<?php
									  ...
									  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<h4><strong><u>@lang("msg.Food & Drink")</u></strong></h4>
										<?php
								  ...
								  <div class="row">
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									  <h4><strong><u>@lang("msg.Activity")</u></strong></h4>
									  <?php
									  ...
									  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<h4><strong><u>@lang("msg.Travel & Places")</u></strong></h4>
										<?php
									  ...
									  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<h4><strong><u>@lang("msg.Objects")</u></strong></h4>
										<?php
								  ...
								  <div class="row">
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									  <h4><strong><u>@lang("msg.Symbols")</u></strong></h4>
									  @php
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									  <h4><strong><u>@lang("msg.Flags")</u></strong></h4>
									  <?php
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									  <h4><strong><u>@lang("msg.Skin Tones")</u></strong></h4>
									  <?php
								  ...
								  <div class="row">
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									  <h4><strong><u>@lang("msg.Uncategorized")</u></strong></h4>
									  <?php
