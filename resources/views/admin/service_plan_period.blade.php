...
<div class="box box-primary ">   
	...
	<span><b class="pull-right text-success">Price: ${{$query->price}}</b></span>
	</h4>    
					...
					<table class="table table-striped">
						<tbody>
							...
							<tr>
								...
								<td><span class="pull-right"><a href="../view_plan_details/{{ $ac->pros_id }}/{{$ac->care_plan_id}}" class="btn btn-default"><i class="material-icons md-22"> visibility </i> View</a></span></td>
							</tr>
							@endforeach
						</tbody>
					</table>
