...
<body class="hold-transition register-page">
    <div class="register-box">        
        <div class="register-box-body">
            <p class="login-box-msg">Employee Voluntary Retirement</p>
            <form action="add_bank_detail" method="post">
				...
				<div class="form-group has-feedback">
					Date of Retirement
					<input type="text" class="form-control" placeholder="" name="retirement_date" id="retirement_date" data-validation="required" data-validation-error-msg="This Field is Required"/>
					<script type="text/javascript"> $('#retirement_date').datepicker({format: 'yyyy/mm/dd'});</script> 
				</div>
