...
<body class="hold-transition register-page">
    <div class="register-box">        
        <div class="register-box-body">
            <p class="login-box-msg">Stop Salary</p>
            <form action="stop_salary_insert" method="post">
				...
				<div class="form-group has-feedback">
						Date
						<input type="text" class="form-control" placeholder="" name="s_s_date" id="s_s_date" data-validation="required" data-validation-error-msg="This Field is Required"/>
						<script type="text/javascript"> $('#s_s_date').datepicker({format: 'yyyy/mm/dd'});</script> 
					</div>
