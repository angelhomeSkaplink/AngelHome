		...
		<div class="col-md-4">
			<div class="box box-primary">
				...
				<div class="box-body"> 
					...
					<div class="form-group has-feedback">
						Leave Type
						<input type="text" class="form-control" name="leave_type" value="{{ $row->leave_type }}" required />
					</div>	
					<div class="form-group has-feedback">
						No of Days
						<input type="text" class="form-control" name="no_of_days" value="{{ $row->no_of_days }}" required pattern="[0-9]+" Title="Numeric value Only" />
					</div>
					<div class="row">                    
						<div class="col-xs-4">
