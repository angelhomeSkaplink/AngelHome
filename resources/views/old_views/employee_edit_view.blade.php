				...
				<div class="box-body">                 
					...
					<div class="form-group has-feedback">
						...
						<input type="text" class="form-control" name="emp_f_name"
							value="{{ $row->emp_f_name }}" required pattern="[A-Za-z\s]+" Title="Alphabate Character Only" />
					</div>
					<div class="form-group has-feedback">
						Middle Name
						<input type="text" class="form-control" name="emp_m_name"
							value="{{ $row->emp_m_name }}" pattern="[A-Za-z\s]+" Title="Alphabate Character Only" />
					</div>
					<div class="form-group has-feedback">
						Last Name
						<input type="text" class="form-control" name="emp_l_name"
							value="{{ $row->emp_l_name }}" required pattern="[A-Za-z\s]+" Title="Alphabate Character Only" />
					</div>
					<div class="form-group has-feedback">
						Post
				...
				<div class="box-body">
					...
					<div class="form-group has-feedback">
						...
						<input type="text" class="form-control" name="emp_contact_no"
							value="{{ $row->emp_contact_no }}" pattern="[0-9]+" Title="Numbers Only" />
					</div>
					<div class="form-group has-feedback">
						Alternate Phone No
					...
					<div class="form-group has-feedback">
						...
						<input type="text" class="form-control" name="bank_account_number"
							value="{{ $row->bank_account_number }}" required pattern="[0-9]+" Title="Numbers Only" />
					</div>
					<div class="form-group has-feedback">
						Bank Name
						<input type="text" class="form-control" name="bank_name"
							value="{{ $row->bank_name }}" required pattern="[A-Za-z\s]+" Title="Characters Only" />
					</div>
					<div class="form-group has-feedback">
						IFSC Code
						<input type="text" class="form-control" name="ifsc"
							value="{{ $row->ifsc }}" required />
					</div>					
				</div>
			</div>
		</div>	
