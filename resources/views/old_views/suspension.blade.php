...
<body class="hold-transition register-page">
    <div class="register-box">        
        <div class="register-box-body">
            <p class="login-box-msg">Suspension</p>
            <form action="suspend" method="post">
				...
				<div class="form-group has-feedback">
					Date of Suspension
					<input type="text" class="form-control" placeholder="Date of Appointment" name="sus_date" id="sus_date" value=""/>
					<script type="text/javascript"> $('#sus_date').datepicker({format: 'yyyy/mm/dd'});</script>
				</div>
