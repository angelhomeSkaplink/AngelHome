        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">					
					...
					@endif
					{!! Form::open(array('route' => 'pension.update_hra_increment', 'id' => 'pension.increment_update')) !!}
						<div class="col-md-4">
							<div class="form-group has-feedback">
								<input type="text" class="form-control" placeholder="Date of HRA Increment" name="doi" id="doi" required />
