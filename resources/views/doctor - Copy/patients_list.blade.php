                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="padding-left-35">
                                <a href="add_patient_details/{{ $patient->id }}" data-toggle="tooltip" data-placement="bottom" title="Add Details">
                                    <i class="material-icons gray md-22"> add_circle</i>
                                </a>
                            </td>
							
                            <td class="padding-left-35">
                                <a href="view_patient_details/{{ $patient->id }}" data-toggle="tooltip" data-placement="bottom" title="View Details">
