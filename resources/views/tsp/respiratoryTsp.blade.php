<h3 style="padding:0px;margin:0px;"><strong>respiratory Problem</strong></h3><br/>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <ol type="1">
                        ...
                        <li>Please call / report to nurse immediatelyif increasing
                             shortness of breath orcongestion, change in mental status,increase in symptoms,
                             change in vitalsigns (fever, etc.), potential adverse reactions to antibiotic</li>
