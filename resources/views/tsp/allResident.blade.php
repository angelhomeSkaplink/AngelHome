                ...
                <table class="table">
                    <tbody>
						...
						<tr>
							...
							<td style=""><a data-toggle="tooltip" data-placement="bottom" data-original-title="View TSP Records" href="screening_view/{{ $r->id }}"><i class="material-icons gray md-22"> visibility </i></a></td>
						</tr>
						@endforeach
                    </tbody>
                </table>
