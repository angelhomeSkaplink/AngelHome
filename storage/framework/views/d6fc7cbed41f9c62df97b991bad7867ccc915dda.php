                    ...
                    <table class="table">
                        <tbody>
    						...
    						<tr>
    							...
    							<?php } ?>
    							<td><a href="set_task/<?php echo e($crm->id); ?>"><span class="label label-primary font-size-80pc padding-7 success-bg padding-top-bottom-5 font-400">SET TASK SHEET</a></span></td>
    						</tr>
