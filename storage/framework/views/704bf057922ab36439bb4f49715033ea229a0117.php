...
<?php $__env->startSection('contentheader_title'); ?>
   <p class="text-danger"><b>Future resident</b>
		<!--<a href="<?php echo e(url('appointment_schedule')); ?>" class="btn btn-primary btn-block btn-flat btn-width btn-custom" style="width:135px !important; margin-top: -2px; margin-right: 10px;"><i class="material-icons md-14 font-weight-600"> keyboard_arrow_left </i> back</a>-->
	</p>
<?php $__env->stopSection(); ?>
            ...
            <div class="box-body border padding-top-0 padding-left-right-0">
                <table class="table">
                    <tbody>
						...
						<tr>
							<?php if($appointment->service_image == NULL): ?>
							<td><img src="hsfiles/public/img/538642-user_512x512.png" class="img-circle" width="40" height="40"></td>	
							<?php else: ?>
							<td><img src="hsfiles/public/img/<?php echo e($appointment->service_image); ?>" class="img-circle" width="40" height="40"></td>
							<?php endif; ?>
							<td><?php echo e($appointment->pros_name); ?></td>								
							<td><?php echo e($appointment->appointment_date); ?></td>
							<td><?php echo e($appointment->appointment_time); ?></td>
							<td class="padding-left-82"><a href="reschedule/<?php echo e($appointment->appoiuntment_id); ?>"><i class="material-icons gray md-22">schedule </i></a></td>
						</tr>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                       </tbody>
                </table>
				<div class="text-center"><?php echo e($appointments->links()); ?></div>
            </div>                
        </div>
    </div>
</div>
