            ...
            <div class="box-body border padding-top-0 padding-left-right-0">
				<div class="table-responsive">
					<table class="table">
						<tbody>
							<tr>
								<th class="th-position text-uppercase font-500 font-12">ASSESSMENTS</b></th>
								<th class="th-position text-uppercase font-500 font-12">Date</b></th>
								<th class="th-position text-uppercase font-500 font-12">Points</b></th>						
							...
							<tr>
								<td><?php echo e($data->assessment_form_name); ?></td>
								<td><?php echo e($data->assessment_date); ?></td>
								<td><?php echo e($data->score); ?></td>
								<td><a href="../../history/<?php echo e($data->pros_id); ?>/<?php echo e($data->id); ?>"><i class="material-icons gray md-22"> visibility </i></a></td>
							</tr>
