...
<?php $__env->startSection('htmlheader_title'); ?>
    <?php echo app('translator')->get("msg.Add Stock Info"); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_title'); ?>
    <p class="text-danger"><b>Add Stock Info</b>
    <a href="<?php echo e(url('medicine_stocks_list')); ?>" class="btn btn-primary btn-block btn-flat btn-width btn-custom" style="width:135px !important; margin-top: -2px; margin-bottom: 9px !important; margin-right: 15px;"><i class="material-icons md-14 font-weight-600"> keyboard_arrow_left </i> <?php echo app('translator')->get("msg.Go Back"); ?></a>
    </p>
<?php $__env->stopSection(); ?>
    ...
    <div class="container">
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade active in" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <form action="<?php echo e(action('MedicineStockHistoryController@store_stocks')); ?>" method="post">
					...
					<div class="col-md-4">	
						<div class="box-body">
							<div class="form-group has-feedback">
								<label><?php echo app('translator')->get("msg.Resident"); ?></label>
								<select name="pros_id" id="pros_id"  class="form-control" required>
									...
									<?php
										...
										foreach ($pros as $pros)
										{
											...
											?>
												<option value="<?php echo e($pros->id); ?>"><?php echo e($n[0]); ?> <?php echo e($n[1]); ?> <?php echo e($n[2]); ?></option>
											<?php
										}
									?>
								</select>
							...
							<div class="form-group has-feedback">
								<label><?php echo app('translator')->get("msg.Pharmacy"); ?></label><br/>
							...
							<div class="form-group has-feedback">
								<label><?php echo app('translator')->get("msg.Stock End Date"); ?></label>
							...
							<div class="form-group has-feedback">
								<a href="<?php echo e(url('medicine_stocks_list')); ?>" class="btn btn-primary btn-danger btn-block btn-flat btn-width btn-sm" style="margin-right:15px"><?php echo app('translator')->get("msg.Cancel"); ?></a>
							</div><br/><br/><br/>
						</div>
					</div>
            	</form>
