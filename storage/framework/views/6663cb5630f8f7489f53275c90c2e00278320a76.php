                    ...
                    <table class="table">
                        <tbody>
    						...
    						<tr>
    							...
    							<?php } ?>
    							<td><a href="upload_file/<?php echo e($crm->id); ?>"><span class="label label-primary font-size-80pc padding-7 success-bg padding-top-bottom-5 font-400">Upload Recording</a></span></td>
    						</tr>
...
<script type="text/javascript" language="javascript" src="<?php echo e(asset('/js/rec/assement_upload.js')); ?>"></script>
<?php $__env->stopSection(); ?>
