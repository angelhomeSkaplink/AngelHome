<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="panel panel-default zoom">
                    <a href="facility_room_graph/<?php echo e($id); ?>">
            ...
            <div class="col-lg-3">
                <div class="panel panel-default zoom">
                    ...
                    ?>    
                    <h4 class="text-center" style="margin-top:0px;"><u><?php echo e($todayWithDay); ?></u></h4>
                    <?php if($data->isEmpty()): ?>
                        <h4 class="text-center" style="padding-top:50px;"><span style="color:#b3b3b3;">No event found</span></h4>
                    <?php else: ?>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <div style="border-bottom:1px solid #e3e3e3;">
                            <span class="" style="color:#999999;"> <i class="material-icons">access_time</i> <?php echo e($e->event_time); ?></span> 
                                <h5> 
                                <span style="color:#337ab7;">&#x<?php echo e($e->emoji_code); ?>;<?php echo e($e->event_name); ?>:</span>
                                <span style="padding-left:2px;color:#999999;padding-top:0px;text-transform:lowercase;"><?php echo e($e->event_description); ?></span>
                                </h5>
                            </div>
            ...
            <div class="col-lg-3">
                <div class="panel panel-default zoom">
                    ...
                    <div class="panel-body box-body make-scrollable">
                        ...
                        <?php endif; ?>
                        <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <div class="row" style="border-bottom:1px solid #e3e3e3;padding:5px;">
                            <div class="col-lg-3">
                            <?php if($a->service_image == NULL): ?>
                                <img src="hsfiles/public/img/538642-user_512x512.png" class="img-circle" width="40" height="40">
                                <?php else: ?>
                                <img src="hsfiles/public/img/<?php echo e($a->service_image); ?>" class="img-circle" width="40" height="40">
                            <?php endif; ?>
                            </div>
                            <div class="col-lg-9">
                                <p style="padding-top:10px;"><?php echo e($a->pros_name); ?></p>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    </div>
