...
<div class="row">
	...
	<div class="col-lg-4">
		...
		<a href="<?php echo e(url('view_patient_details/'.$id)); ?>" class="btn btn-info btn-sm " style="margin-right:15px;border-radius:5px;"><i class="material-icons">details</i>View Details</a>
		</span>
	</div>
</div>
<?php $__env->stopSection(); ?>
