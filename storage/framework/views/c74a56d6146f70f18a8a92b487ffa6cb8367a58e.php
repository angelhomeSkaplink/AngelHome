					...
					<ul class="sidebar-menu">
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								...
								<li>
								    <a href="<?php echo e(url('preadmin_resident_assessment')); ?>">
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								...
								<li>
        							...
        							<ul class="treeview-menu">
        								<li><a href="<?php echo e(url('preadmin_resident_assessment')); ?>"><i class="material-icons md-18 dark-gray"> assessment </i><span class="padding-left-10"><?php echo app('translator')->get("msg.Main Assessment"); ?></a></li>
