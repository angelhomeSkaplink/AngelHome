					...
					<ul class="sidebar-menu">
							...
							<ul class="treeview-menu">
							    <li>
									<a href="<?php echo e(url('personal_details')); ?>">
										...
										<span class="padding-left-10"><?php echo app('translator')->get("msg.Resident Details"); ?></span>
									</a>
								</li>
								<li>
                        ...
                        <li class="treeview">
							...
							<ul class="treeview-menu">
								...
								<li><a href="<?php echo e(url('resident_service_plan_graph')); ?>"><i class="material-icons md-18 dark-gray">work</i><span class="padding-left-10"></span>Service Plan Report</a></li>
						        <li><a href="<?php echo e(url('assessment_report_graph')); ?>"><i class="material-icons md-18 dark-gray">work</i><span class="padding-left-10"></span>Main Assessment Report</a></li>
							</ul>
						</li>
							<?php endif; ?>
