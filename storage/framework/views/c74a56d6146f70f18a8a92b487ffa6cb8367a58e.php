...
<html lang="en">
	<head>
		...
		<!--<script type="text/javascript" language="javascript" src="<?php echo e(asset('/js/jquery.min.js')); ?>"></script>-->
							...
							<!-- User Account Menu -->
								...
								<!--<li class="dropdown user user-menu">
									...
									<!--<a href="#" class="dropdown-toggle" data-toggle="dropdown">
										...
										<span class="hidden-xs" style="text-transform:uppercase; font-weight:600"><?php echo e(Auth::user()->firstname." ".Auth::user()->lastname); ?></span>
									</a>
									<ul class="dropdown-menu">
										<!-- The user image in the menu -->
										<!--<li class="user-header">
											<img src="<?php echo e(url(Auth::user()->image)); ?>" class="img-circle" alt="User Image"/>
											<p>
										...
										<li class="user-footer">
											<div class="pull-left">
												...
												<!--<a href="profile/<?php echo e(Auth::user()->user_id); ?>" class="btn btn-default btn-flat">Profile</a>
											</div>
										</li>
									</ul>
								</li>-->						
					...
					<ul class="sidebar-menu">
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								...
								<!--<li><a href="<?php echo e(url('room_details')); ?>">Admission Policies</a></li>-->
							</ul>
						</li>
						<!--<li class="">
							<a href="<?php echo e(url('activity_calendar')); ?>">
						...
						<li class="treeview">
							...
							<li><a href="<?php echo e(url('personal_details')); ?>"><i class="material-icons md-18 dark-gray"> details </i><span class="padding-left-10"><?php echo app('translator')->get("msg.Future Resident Details"); ?></span></a></li>
						...
						<?php if(in_array(5,$role_arr)): ?>
							...
							<li><a href="<?php echo e(url('injury')); ?>"><i class="material-icons md-18"> assignment</i><span class="padding-left-10"><?php echo app('translator')->get("msg.Incident"); ?></span></a></li>
