...
<?php $name = DB::table('sales_pipeline')->where('id', $id)->first(); ?>
  <p class="text-danger"><b>ADD mental status details for <?php echo e($name->pros_name); ?></b></p>
<?php $__env->stopSection(); ?>
...
<div class="box box-primary padding-bottom-25">
  <div class="container">
    <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-left:-14px; margin-right:-14px; margin-top:1px">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../primary_doctor/<?php echo e($id); ?>">PRIMARY DOCTOR</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../pharmacy/<?php echo e($id); ?>">PHARMACY</a>
      </li>
      <li class="nav-item">
    ...
    <div class="tab-content" id="myTabContent">
      <div class="">
        <div class="col-md-12">
							<div class="box-body">
								<form action="<?php echo e(action('ScreeningController@add_mental_status')); ?>" method="post">
