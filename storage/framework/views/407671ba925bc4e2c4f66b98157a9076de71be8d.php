...
<?php $__env->startSection('contentheader_title'); ?>
    <p class="text-danger"><b><?php echo app('translator')->get("msg.Upcoming Events"); ?></b>
	<?php
	...
	?>
	<?php if(in_array(9,$role_arr)): ?>
	<a href="<?php echo e(url('new_event_add_form')); ?>" class="btn btn-primary btn-block btn-flat btn-width btn-custom" style="width:187px !important; margin-top: -2px; margin-right: 10px;"><i class="material-icons md-14 font-weight-600"> add </i><?php echo app('translator')->get("msg.Add New Event"); ?></a>
	<?php endif; ?>
	</p>
<?php $__env->stopSection(); ?>
