...
<div class="row">
	<div class="col-lg-4 col-lg-offset-4 text-center">
		<h3 style="margin:0px;color:rgba(0, -3, 0, 0.87) !important;"><strong>Aging Report For the Group: <span class="text-aqua"><?php echo e($group->facility_name); ?></span></h3>
	</div>
</div>
<?php $__env->stopSection(); ?>
                    ...
                    <table class="table">
                        <tbody>
							...
							<tr>
								...
								<td class="padding-left-45"><a href="facility_aging_graph_reports/<?php echo e($facility->id); ?>">
