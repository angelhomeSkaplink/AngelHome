			...
			if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
			  ...
			  b.addEventListener("click", function(e) {
				  ...
				  $(inp).on('change', function() {	
					...
					if(pros_id) {
						$.ajax({
							url: 'select_pros_upload/'+pros_id,
							type: "GET",
							success:function(data) {
								window.location.replace('select_pros_upload/'+pros_id);
							}
						});
					}
			...
			if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
			  ...
			  b.addEventListener("click", function(e) {
				  ...
				  $(inp).on('change', function() {	
					...
					if(pros_id) {
						$.ajax({
							url: 'select_pros_upload_email/'+pros_id,
							type: "GET",
							success:function(data) {
								window.location.replace('select_pros_upload_email/'+pros_id);
							}
						});
					}
					$(this).unbind('change')
			...
			if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
			  ...
			  b.addEventListener("click", function(e) {
				  ...
				  $(inp).on('change', function() {	
					...
					if(pros_id) {
						$.ajax({
							url: 'select_pros_upload_contact/'+pros_id,
							type: "GET",
							success:function(data) {
								window.location.replace('select_pros_upload_contact/'+pros_id);
							}
						});
					}
					$(this).unbind('change')
