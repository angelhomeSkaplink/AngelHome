			...
			if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
			  ...
			  b.addEventListener("click", function(e) {
				  ...
				  $(inp).on('change', function() {	
					...
					if(pros_id) {
						$.ajax({
							url: 'screening_pros_email/'+pros_id,
							type: "GET",
							success:function(data) {
								window.location.replace('screening_pros_email/'+pros_id);
							}
						});
					}
					$(this).unbind('change')
			...
			if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
			  ...
			  b.addEventListener("click", function(e) {
				  ...
				  $(inp).on('change', function() {	
					...
					if(pros_id) {
						$.ajax({
							url: 'screening_pros_contact/'+pros_id,
							type: "GET",
							success:function(data) {
								window.location.replace('screening_pros_contact/'+pros_id);
							}
						});
					}
					$(this).unbind('change')
