			...
			if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
			  ...
			  b.addEventListener("click", function(e) {
				  ...
				  $(inp).on('change', function() {	
					...
					if(pros_id) {
						$.ajax({
							url: 'search_patient/'+pros_id,
							type: "GET",
							success:function(data) {
								window.location.replace('search_patient/'+pros_id);
							}
						});
					}
			...
			if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
			  ...
			  b.addEventListener("click", function(e) {
				  ...
				  $(inp).on('change', function() {	
					...
					if(pros_id) {
						$.ajax({
							url: 'search_patient_contact/'+pros_id,
							type: "GET",
							success:function(data) {
								window.location.replace('search_patient_contact/'+pros_id);
							}
						});
					}
					$(this).unbind('change')
